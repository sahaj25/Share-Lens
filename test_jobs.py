...
def send_telegram(message: str):
    url = f"https://api.telegram.org/bot8770271127:AAGtE9-BoIUbEfz9pR67HxNVWq_9tQXdCMo/sendMessage"
...
def main():
    print(f"Scheduler started. Jobs at: {SCHEDULE_TIMES}")

    for t in SCHEDULE_TIMES:
        schedule.every().day.at(t).do(run_job)

    # Run once immediately on start (optional, comment out if not needed)
    #
    # run_job()
